...
// ---------------------------------------------------------------------
// Template data. Each entry maps to a real canvas size in px at 300 DPI
// equivalents scaled down for screen editing — these are the actual
// dimensions the editor opens at, not decorative numbers.
// ---------------------------------------------------------------------
