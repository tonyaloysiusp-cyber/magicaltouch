...
// lib/editor/types.ts
//
// Single source of truth for editor-wide types. Previously these lived
// inline at the top of the 2000-line editor page; pulling them out means
// every hook/component below can import the same definitions instead of
// re-declaring narrower/looser copies.
// ---------------------------------------------------------------------
