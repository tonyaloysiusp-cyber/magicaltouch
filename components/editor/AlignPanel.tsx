...
export function AlignPanel({ alignObject, hasSelection }: Props) {
  const btn = (
    ...
    <button
      ...
      className="w-8 h-8 flex items-center justify-center border rounded hover:bg-purple-50 disabled:opacity-30 disabled:hover:bg-transparent text-gray-600"
    >
      {icon}
    </button>
  );
  ...
  return (
    <div className="p-3">
      <p className="font-semibold text-gray-700 mb-3 text-sm">Align</p>
      ...
      <p className="text-[10px] font-semibold text-gray-300 mb-1.5 uppercase tracking-wide">
        Distribute (Planned)
      </p>
