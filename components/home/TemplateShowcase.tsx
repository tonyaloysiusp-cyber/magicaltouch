...
export function TemplateShowcase() {
  ...
  return (
    <section className="bg-gradient-to-r from-[#EAF6FB] via-white to-[#FDF4F8] dark:bg-[#17151F] dark:from-transparent dark:via-transparent dark:to-transparent border-y border-black/10 dark:border-white/10">
