      ...
      <div className="flex h-[340px] sm:h-[400px]">
        ...
        <div className="flex-1 flex flex-col bg-[#EDEBE5] relative">
          <div className="flex-1 flex items-center justify-center p-6 gap-4 overflow-hidden">
            ...
            <div className="hidden md:block w-24 h-14 rounded-md shadow-md shrink-0 opacity-70 scale-95 bg-white border border-black/10 p-2">
            ...
            <div className="relative w-40 h-40 sm:w-48 sm:h-48 rounded-lg shadow-2xl shrink-0 overflow-hidden ring-2 ring-[#6C4FD1]">
            ...
            <div className="hidden md:block w-16 h-28 rounded-md shadow-md shrink-0 opacity-70 scale-95 overflow-hidden">
